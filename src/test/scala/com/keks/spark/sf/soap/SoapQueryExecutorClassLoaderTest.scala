...
import com.keks.spark.sf.SfOptions.{SF_API_VERSION, SF_AUTH_END_POINT, SF_USER_NAME, SF_USER_PASSWORD}
...
class SoapQueryExecutorClassLoaderTest extends TestBase {
  ...
  "QueryExecutorClassLoader#SoapQueryExecutor" should "load SoapQueryExecutor" in {
    val className = "com.keks.spark.sf.soap.TrySoapQueryExecutor"
