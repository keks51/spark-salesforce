...
class LastOffsetIntegerTest extends TestBase with MockedServer with DataFrameEquality {
  ...
  def tests(sfFormat: String): Unit = {
    it should "load data with Integer offset" in withMockedServer(wireMockServerHost, wireMockServerPort) { _ =>
      ...
      val sfRecordsList1 = Seq(
        Seq(SfRecord(ID, Some("a")), SfRecord(AGE, Some("1")), SfRecord(SYSTEMMODSTAMP, Some("2020-01-01T00:00:00.000Z"))),
        Seq(SfRecord(ID, Some("b")), SfRecord(AGE, Some("2")), SfRecord(SYSTEMMODSTAMP, Some("2020-01-01T00:00:01.000Z"))),
        Seq(SfRecord(ID, Some("c")), SfRecord(AGE, Some("3")), SfRecord(SYSTEMMODSTAMP, Some("2020-01-01T00:00:02.000Z")))
        )
      ...
      val sfRecordsList2: Seq[Seq[SfRecord]] = Seq(
        Seq(SfRecord(ID, Some("d")), SfRecord(AGE, Some("4")), SfRecord(SYSTEMMODSTAMP, Some("2020-01-02T00:00:00.000Z"))),
        Seq(SfRecord(ID, Some("e")), SfRecord(AGE, Some("5")), SfRecord(SYSTEMMODSTAMP, Some("2020-01-02T00:00:01.000Z"))),
        Seq(SfRecord(ID, Some("f")), SfRecord(AGE, Some("6")), SfRecord(SYSTEMMODSTAMP, Some("2020-01-02T00:00:02.000Z")))
        )
      ...
      val result =
        spark
          ...
          .option(SF_INITIAL_OFFSET, "0")
          .option(SF_END_OFFSET, "10")
      ...
      val expected = Seq(
        ("a", 1, t"2020-01-01 00:00:00"),
        ("b", 2, t"2020-01-01 00:00:01"),
        ("c", 3, t"2020-01-01 00:00:02"),
        ("d", 4, t"2020-01-02 00:00:00"),
        ("e", 5, t"2020-01-02 00:00:01"),
        ("f", 6, t"2020-01-02 00:00:02")).toDF(ID, AGE, SYSTEMMODSTAMP)
