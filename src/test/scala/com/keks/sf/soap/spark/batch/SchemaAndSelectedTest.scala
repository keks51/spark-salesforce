...
class SchemaAndSelectedTest extends TestBase with MockedServer with DataFrameEquality with TmpDirectory {
  ...
  def mockSf(): Unit = {
    ...
    val sfRecordsList = Seq(
      Seq(SfRecord(ID, Some("a")), SfRecord(SYSTEMMODSTAMP, Some("2020-10-23T13:39:45.000Z"))),
      Seq(SfRecord(ID, Some("b")), SfRecord(SYSTEMMODSTAMP, Some("2020-10-23T13:39:45.000Z"))),
      Seq(SfRecord(ID, Some("e")), SfRecord(SYSTEMMODSTAMP, Some("2020-10-23T13:39:45.000Z")))
      )
