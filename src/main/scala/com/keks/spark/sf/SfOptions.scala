...
class SfOptions(@transient private val parameters: CaseInsensitiveMap[String],
  ...
  val printDriverLogs: Boolean = getFromOptionsOrSparkConfOpt(SF_PRINT_DRIVER_LOGS).exists { e => isBool(SF_PRINT_DRIVER_LOGS, e); e.toBoolean }
...
object SfOptions {
  ...
  val SF_PRINT_DRIVER_LOGS = newOption("printDriverLogs")
